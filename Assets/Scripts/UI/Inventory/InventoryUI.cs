...
public class InventoryUI : MonoBehaviour
{
    ...
    */
    ...
    public void Init(Inventory inventory)
    {
        ...
        moneyText = inventoryWindow.transform.Find("Inventory/Money/Text").GetComponent<TextMeshProUGUI>();
        weaponSlotUI1 = inventoryWindow.transform.Find("Inventory/WeaponSlot 1").GetComponent<WeaponSlotUI>();
        weaponSlotUI2 = inventoryWindow.transform.Find("Inventory/WeaponSlot 2").GetComponent<WeaponSlotUI>();
        AmmoSlots = inventoryWindow.transform.Find("Inventory/AmmoSlots");
